...
import { ArrowRight, Calendar, Zap, ShieldCheck, Users, MapPin, LogIn } from "lucide-react";
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 py-20">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          >
            ...
            {/* NEW: Login Button */}
            <a
              href="/admin/login" // ← change this path to your actual admin login route
      ...
      <section id="events-types" className="py-20 px-6 bg-gradient-to-b from-purple-50/40 to-transparent">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { name: "Concerts", img: "https://images.unsplash.com/photo-1540039156090-7c6a2e6b8e10?w=800" },
